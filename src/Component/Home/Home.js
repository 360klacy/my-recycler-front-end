        ...
        return(<>
            ...
            <section className="our-story-section">
                <div className="our-story-details">
                        ...
                        <div className="spacer"></div>
                        <p>R- Waste was developed and founded in Atlanta, Ga by four young engineers in the south's largest tech hub, Atlanta Tech Village. The idea started off as 
                            ...
                            Have no fear R-Waste is here! Simply sign up, choose your desired recyclables, pick up time, and there you have it, you just saved the world! 
                             All superheroes don't wear capes but with R-Waste you can save OUR world with R-Waste!
                        </p>
                        <div className="spacer"></div>
